...
-- awful.util.tagnames = { "www", "code", "tools", "edit", "folder", "movies", "browser", "chats", "music" }
...
globalkeys = my_table.join(
    ...
    -- awful.util.spawn("brightnessctl s 2%-") end),
    ...
    awful.key({ modkey }, "v", function () awful.util.spawn( "xfce4-clipman-history" ) end,
        {description = "clipman history", group = "super"}),
